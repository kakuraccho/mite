...
func TestGeneratedSupportSessionContainsAllSnapshotFields(t *testing.T) {
	...
	if converted.Id != "session_1" || converted.SupportRequestId != "request_1" || converted.GuideDecision == nil || *converted.GuideDecision != generated.CREATE || converted.Consent == nil || converted.Consent.TextVersion != "v2" || converted.Revision != 3 {
